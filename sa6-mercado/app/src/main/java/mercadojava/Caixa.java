...
import mercadojava.demo.Connection.ClientesDAO;
...
import mercadojava.demo.View.CadastroPanel;
import mercadojava.demo.View.ClientesPanel;
...
public class Caixa extends JFrame {
    ...
    public boolean validaCpf(String cpf) {
        clientes = (List<Cliente>) new ClientesDAO().listarTodos();
